...
const en: TranslationMap = {
  ...
  radarTitle: 'Radar View',
  radarToggle: 'Toggle Radar View',
...
const de: TranslationMap = {
  ...
  detectionsGroupedItem: ({ count, label }) => `${count}x ${label}`,
  streamInfoTitle: 'Stream-Info',
  radarTitle: 'Radar-Ansicht',
  radarToggle: 'Radar-Ansicht umschalten',
...
const fr: TranslationMap = {
  ...
  radarTitle: 'Vue radar',
  radarToggle: 'Basculer la vue radar',
  streamInfoResolution: 'Resolution',
...
const es: TranslationMap = {
  ...
  radarTitle: 'Vista radar',
  radarToggle: 'Alternar vista radar',
...
const it: TranslationMap = {
  ...
  radarTitle: 'Vista radar',
  radarToggle: 'Alterna vista radar',
